...
export const metadata: Metadata = {
  ...
  description:
    "Extended photo library and downloadable portfolio PDF with singles and polaroids for Nikhil Kubde.",
};
        ...
        <ScrollReveal direction='fade' variant='scale-lift'>
          <div className='premium-surface p-8 md:p-12 text-center md:text-left'>
            ...
            <p className='premium-body mt-4 max-w-3xl'>
              The five Montelo campaign images are featured on the home and
              portfolio pages. Below: extended archive photos plus the full comp
              card PDF with singles and polaroids.
            </p>
